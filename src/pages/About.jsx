  ...
  return (
    ...
    <section className="section fade-in">
      <main className="about-section">
        <h2>About</h2>
        <p>Hi, I'm Mayte, a watercolour artist from Mexico. I started Marove Aqua in early 2021 as a small personal project to bring colour and life to my flat. Discovering this medium was a truly transformative experience for me.</p>
        <br/>
